...
namespace Mitternacht.Migrations.Mitternacht
{
    ...
    [Migration("20210406113621_AddForumACcountWatchNotificationChannelIdToGuildConfig")]
    partial class AddForumACcountWatchNotificationChannelIdToGuildConfig
    {
            ...
            modelBuilder.Entity("Mitternacht.Database.Models.GuildConfig", b =>
                {
                    ...
                    b.Property<double>("ColorMetricSimilarityRadius")
                        .HasColumnType("double precision");

                    b.Property<decimal?>("CountToNumberChannelId")
                        .HasColumnType("numeric(20,0)");

                    b.Property<bool>("CountToNumberDeleteWrongMessages")
                        .HasColumnType("boolean");
                    ...
                    b.Property<decimal?>("ForumAccountWatchNotificationChannelId")
                        .HasColumnType("numeric(20,0)");
            ...
            modelBuilder.Entity("Mitternacht.Database.Models.UserRoleColorBinding", b =>
                {
                    ...
                    b.HasIndex("UserId", "GuildId", "RoleId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Mitternacht.Database.Models.Warning", b =>
                {
                    ...
                    b.Property<long>("PointsHard")
                        .HasColumnType("bigint");

                    b.Property<long>("PointsLight")
                        .HasColumnType("bigint");

                    b.Property<long>("PointsMedium")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Mitternacht.Database.Models.BotConfig", b =>
                {
                    ...
                    b.Navigation("BlockedCommands");

                    b.Navigation("BlockedModules");

                    b.Navigation("EightBallResponses");

                    b.Navigation("RotatingStatusMessages");

                    b.Navigation("StartupCommands");
                });
            ...
            modelBuilder.Entity("Mitternacht.Database.Models.GuildConfig", b =>
                {
                    ...
                    b.Navigation("FilterZalgoChannelIds");
