    ...
    public partial class Administration
    {
        ...
        public class LogCommands : MitternachtSubmodule<LogCommandService>
        {
            ...
            public async Task LogServer(PermissionAction action)
            {
                ...
                LogSetting logSetting = uow.GuildConfigs.LogSettingsFor(channel.Guild.Id).LogSetting;
            ...
            public async Task LogIgnore()
            {
                ...
                var removed = logSetting.IgnoredChannels.RemoveWhere(ilc => ilc.ChannelId == channel.Id);
